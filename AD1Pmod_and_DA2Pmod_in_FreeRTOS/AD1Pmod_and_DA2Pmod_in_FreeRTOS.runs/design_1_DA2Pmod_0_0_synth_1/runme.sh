...
HD_PWD='C:/Zynq_Book/AD1Pmod_and_DA2Pmod_in_FreeRTOS/AD1Pmod_and_DA2Pmod_in_FreeRTOS.runs/design_1_DA2Pmod_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DA2Pmod_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DA2Pmod_0_0.tcl
