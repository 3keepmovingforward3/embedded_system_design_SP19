...
HD_PWD='C:/Zynq_Book/bb_PmodAD1/bb_PmodAD1.runs/design_1_PmodAD1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_PmodAD1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_PmodAD1_0_0.tcl
