...
HD_PWD='C:/Zynq_Book/zynq_interrupts/zynq_interrupts.runs/zynq_interrupt_system_axi_gpio_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_interrupt_system_axi_gpio_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_interrupt_system_axi_gpio_1_1.tcl
